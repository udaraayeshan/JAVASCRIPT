...
// // ---First Child---     hariyanne naha-text eka enne
...
// // ---Last Child---       hariyanne naha-text eka enne
// // Work like childnodes
...
// // ---Next Sibling---  eaygema level eke wagee
// // Work like childnodes
// console.log(itemList.nextSibling);

// // ---Next Element Sibling---   [eyagema level eke ilata innna kena]
...
// // --Create an Input--
var input = document.createElement('input'); //createElement
...
// // --Create a Div--
var newDiv = document.createElement('div');    //createElement

// // Create text node
var newText = document.createTextNode('How are you!');

// // Add text to div
newDiv.appendChild(newText);   //appendchild
console.log(newDiv);
...
form.insertBefore(input, button);  //insertBefore
